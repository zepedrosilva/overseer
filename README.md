...
- **🤖 2-Step Agent Selection (<kbd>a</kbd>)**: Select and persist AI agents per repository (`claude`, `agy`, `gemini`, `pi`, `moxly`) with instant `<Enter>` confirmation, followed by optional custom prompt execution in isolated worktrees.
...
```text
┌────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│  ┌─ Diff: MewsSystems/billing#142 (fix/inv-rounding) ─────────────── [Esc to close] ─┐                 │
