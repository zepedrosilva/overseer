...
describe('GraphQL Query Builder & Parser', () => {
  const repos: RepoHandle[] = [
    { owner: 'MewsSystems', repo: 'billing', url: 'https://github.com/MewsSystems/billing', agent: 'claude' },
  ...
  describe('buildBatchPRQuery', () => {
    it('builds valid GraphQL document with aliases for each repo', () => {
      ...
      expect(query).toContain('repo_0: repository(owner: "MewsSystems", name: "billing")');
  ...
  describe('parseGraphQLBatchResponse', () => {
    ...
    it('parses multi-repo GraphQL response into PrState array', () => {
      ...
      const pr1 = result[0];
      expect(pr1.key).toEqual({ owner: 'MewsSystems', repo: 'billing', number: 142 });
              ...
              nodes: [
                {
                  ...
                  url: 'https://github.com/MewsSystems/billing/pull/200',
                  state: 'OPEN',
  ...
  describe('parseGraphQLSearchResponse', () => {
        ...
        search: {
          ...
          nodes: [
            ...
            },
            {
              ...
              url: 'https://github.com/MewsSystems/architecture-scorecards/pull/88',
              isDraft: false,
              state: 'OPEN',
              headRefName: 'fix/config',
              baseRefName: 'master',
              repository: {
                name: 'architecture-scorecards',
                owner: { login: 'MewsSystems' },
              },
    ...
    it('parses search GraphQL response and extracts repository dynamically', () => {
      ...
      expect(result[1].key).toEqual({ owner: 'MewsSystems', repo: 'architecture-scorecards', number: 88 });
